...
/*   Updated: 2019/12/09 18:41:51 by pramella    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
void ft_print_error(int flag, void *arg)
{
	...
	//(flag == 2) ? ft_printf("Path \"%s\" is not valid.\n", arg) : 1;
...
{
	(color_ptr->red < 0 || color_ptr->red > 255) ? ft_print_error(1, &(color_ptr->red)) : 0;
	(color_ptr->green < 0 || color_ptr->green > 255) ? ft_print_error(1, &(color_ptr->red)) : 0;
	(color_ptr->blue < 0 || color_ptr->blue > 255) ? ft_print_error(1, &(color_ptr->red)) : 0;
}
...
{
	((*map)->res_ptr->x <= 0 || (*map)->res_ptr->y <= 0) ? (ft_print_error(0, (void *)0)) : 1;
